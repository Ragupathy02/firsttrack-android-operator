...
import com.firstpage.user.Adapter.OngoingworkAdapter;
...
import com.firstpage.user.Interfaces.AdapterCallback;
...
import com.firstpage.user.Model.Ongoing_error;
...
public class OngoingFragment extends Fragment  {
    ...
    OngoingworkAdapter ongoing_adapter;
    String getArgument;
   Context context1;
    ...
    public OngoingFragment(Context context1) {
...
////                            ongoing_adapter = new OngoingworkAdapter(ongoing_workArrayList,order_processArrayList,getActivity());
...
////                        jsonResponse = response.body();
////                        ongoing_adapter = new OngoingworkAdapter(ongoing_workArrayList,getActivity());
////                        ongoing_workArrayList.addAll(response.body().getData());
////                        ongoing_recyclerview.setAdapter(ongoing_adapter);
//                    }
//
...
//                             Log.e("ragu", "onResponse:size "+ongoing_workArrayList.size() );
                             ...
                             ongoing_adapter = new OngoingworkAdapter(ongoing_workArrayList,response.body().getData().get(i).getLine_numbers().getIs_exception(),getActivity(), new OngoingworkAdapter.ListAdapterListener() {
                                 @Override
        ...
        ongoing_responseCall.enqueue(new Callback<Ongoing_response>() {
            ...
            public void onResponse(Call<Ongoing_response> call, Response<Ongoing_response> response) {
                ...
                if(response.body().getStatus())
                {
                    if(response.body().getData().size()>0)
                    {
                        ongoing_adapter = new OngoingworkAdapter(response.body().getData(),response.body().getData().get(i).getLine_numbers().getIs_exception(),getActivity(), new OngoingworkAdapter.ListAdapterListener() {
                            @Override
                            public void onClickAtOKButton(String position) {
                                Log.e("ragu", "onClickAtOKButton: "+position );
//                                     sharedPreference.putString(getActivity(),"exception",position);
...
//                    {
//                        ongoing_adapter = new OngoingworkAdapter(response.body().getData(),getActivity());
...
//                    for(int i=0;i<response.body().getData().size();i++)
//                    {
//                        ongoing_adapter = new OngoingworkAdapter(response.body().getData(),response.body().getData().get(i).getOrder_process().get(i),getActivity());
//                        ongoing_recyclerview.setAdapter(ongoing_adapter);
//
//                    }
////                    if(response.body().getData().size()>0)
